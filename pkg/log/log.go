...
func (l *LogService) GetPodContainers(client kubernetes.Interface, namespace, podID string) (*PodContainerList, error) {
...
func (l *LogService) GetLogDetails(client kubernetes.Interface, namespace, podID string, container string,
	...
	details := l.ConstructLogDetails(podID, rawLogs, container, logSelector)
	return details, nil
}
...
func (l *LogService) GetLogFile(client kubernetes.Interface, namespace, podID string, container string, usePreviousLogs bool) (io.ReadCloser, error) {
	logOptions := &v1.PodLogOptions{
		Container:  container,
		Follow:     false,
...
func (l *LogService) ConstructLogDetails(podID string, rawLogs string, container string, logSelector *logs.Selection) *logs.LogDetails {
